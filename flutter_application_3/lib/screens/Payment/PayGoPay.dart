...
class _PayGoPayState extends State<PayGoPay> {
  ...
  Widget build(BuildContext context) {
    return ListView(
      children: const [
        ExpansionTile(
          ...
          children: [
            ListTile(
              ...
              subtitle: Text(
                '1. Buka halaman internet banking GoPay (https://gopay.co.id)\n'
                '2. Lakukan login dan masukkan user ID dan password Anda\n'
                '3. Pilih “Transfer” > Pilih “Transfer ke GoPay Virtual Account”\n'
        ...
        ExpansionTile(
          title: Text('Mobile Banking GoPay'),
          children: [
            ListTile(
              title: Text('Panduan Mobile Banking GoPay'),
              subtitle: Text(
                '1. Buka aplikasi Mobile GoPay\n'
                '2. Lakukan login dengan user ID dan PIN\n'
                '3. Pilih “m-Transfer” > “Transfer ke GoPay Virtual Account”\n'
                '4. Masukkan nomor virtual account\n'
        ...
        ExpansionTile(
          title: Text('ATM GoPay'),
          children: [
            ListTile(
              title: Text('Panduan ATM GoPay'),
              subtitle: Text(
                '1. Masukkan kartu ATM dan PIN Anda\n'
                '2. Pilih “Transaksi Lain” > “Transfer” > “Ke Rek. GoPay Virtual Account”\n'
