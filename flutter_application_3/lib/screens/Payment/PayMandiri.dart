...
class PayMandiri extends StatefulWidget {
  final String doctorName;
  final String doctorSpecialty;
  final int consultationFee;
  final String imagePath;
  final String choice; // Tambahkan parameter choice
  ...
  const PayMandiri({
    ...
    required this.choice, // Tambahkan parameter choice
  }) : super(key: key);

  @override
  _PayMandiriState createState() => _PayMandiriState();
}

class _PayMandiriState extends State<PayMandiri> {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => PaySuccess(
          ...
          productName: widget.doctorSpecialty,
          choice: widget.choice, // Tambahkan parameter choice
        ),
      ),
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Image.asset(
                    'assets/images/mandiri.png', // Update with Mandiri logo
                    width: 40,
                    height: 40),
                SizedBox(width: 8),
                Text('Mandiri', style: TextStyle(fontSize: 16)),
              ],
            ),
            SizedBox(height: 8),
            Text(
              '70012-1234567890', // Example VA number
  ...
  Widget build(BuildContext context) {
    return ListView(
      children: const [
        ExpansionTile(
          ...
          children: [
            ListTile(
              ...
              subtitle: Text(
                '1. Buka halaman internet banking Mandiri (https://ib.bankmandiri.co.id)\n'
        ...
        ExpansionTile(
          title: Text('Mobile Banking Mandiri'),
          children: [
            ListTile(
              title: Text('Panduan Mobile Banking Mandiri'),
              subtitle: Text(
                '1. Buka aplikasi Mandiri Online\n'
                '2. Lakukan login dengan user ID dan PIN\n'
                '3. Pilih “Bayar” > “Multi Payment”\n'
                '4. Masukkan nomor virtual account\n'
                '5. Periksa kembali detail pembayaran\n'
                '6. Masukkan PIN Mandiri\n'
        ...
        ExpansionTile(
          ...
          children: [
            ListTile(
              title: Text('Panduan ATM Mandiri'),
              subtitle: Text(
